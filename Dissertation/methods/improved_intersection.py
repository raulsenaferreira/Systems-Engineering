...
def start(**kwargs):
    ...
    print("METHOD: LP as classifier and {} and Hellinger distance as dynamic CSE".format(densityFunction))
    ...
    return "LP + KDE + Dyn CSE by class", arrAcc, X, y, arrX, arrY, arrUt, arrYt, arrClf, arrPredicted